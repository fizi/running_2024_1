...
$PAGE_TEMPLATE['default']['body'] = '
    ...
    <div class="default-cpage-share d-flex justify-content-end">
      <div class="social-share-icons">{SOCIALSHARE}</div>
    </div>
    {CPAGERELATED: types=page&limit=3}
    <div class="default-cpage-comments">
      <h4 class="default-cpage-comments-title">{LAN=LAN_THEME_81}</h4>
...
<div class="related-cpage-box mt-4">
  <h4 class="related-cpage-caption">{LAN=LAN_RELATED}</h4>
  <div class="triangle-down"></div>
...
$PAGE_TEMPLATE['default']['related']['item'] = '
      <div class="col-lg-4 d-flex align-items-stretch mb-5">
        <div class="related-cpage-item h-100 d-flex flex-column">
          <div class="related-cpage-image mb-2">
            <a href="{RELATED_URL}">{RELATED_IMAGE}</a>
          </div> 
          <h4 class="related-cpage-title mb-0"><a href="{RELATED_URL}">{RELATED_TITLE}</a></h4>
        </div>
      </div>
';
