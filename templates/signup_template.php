...
<div class='row border-bottom border-secondary border-opacity-25 py-2'>{---}</div>";
...
<div id='signup'>
  <div class='signup-coppa-text'>{SIGNUP_COPPA_TEXT}</div>
  <div class='text-center'>
    <div class='fw-bold py-4'>{LAN=LAN_SIGNUP_17}</div>
    {SIGNUP_COPPA_FORM}
  </div>
</div>";

$SIGNUP_TEMPLATE['coppa-fail'] = "
<div class='alert alert-danger alert-block text-center'>{LAN=LAN_SIGNUP_9}</div>";
