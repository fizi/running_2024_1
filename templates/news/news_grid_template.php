...
$NEWS_GRID_TEMPLATE['home-latest-news']['start'] = '
<div class="home-latest-news-header-1 pt-5 px-3"><h2 class="text-center">{LAN=LAN_THEME_100}</h2></div>
<div class="home-latest-news-header-2 pt-3 px-3"><h5 class="text-center fst-italic">{LAN=LAN_THEME_101}</h5></div>
<div class="py-5">
  <div class="row">
';
$NEWS_GRID_TEMPLATE['home-latest-news']['featured'] = ' ';
$NEWS_GRID_TEMPLATE['home-latest-news']['item'] = '
    <div class="col-lg-4 d-flex align-items-stretch mb-3">
      <div class="news-item">          
        ...
        <div class="news-content">
          <h4 class="news-title text-center">{NEWS_TITLE: link=1}</h4>
          <div class="news-summary">{NEWS_SUMMARY: limit=200}</div>                      
        </div>
      </div>
    </div>
';
$NEWS_GRID_TEMPLATE['home-latest-news']['end'] = '     
  </div>
</div>
';
