...
$NEXTPREV_TEMPLATE['bootstrap_nav_first'] = '
    <li class="page-item"><a class="page-link first hidden-xs" href="{url}" title="{url_label}">{label}</a></li>
';
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '
    <li class="page-item"><a class="page-link prev" href="{url}" title="{url_label}"><i class="fas fa-arrow-left"></i></a></li>
';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] = '
    <li class="page-item"><a class="page-link last hidden-xs" href="{url}" title="{url_label}">{label}</a></li>
';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '
    <li class="page-item"><a class="page-link next" href="{url}" title="{url_label}"><i class="fas fa-arrow-right"></i></a></li>
';
$NEXTPREV_TEMPLATE['bootstrap_items_start'] = '
';
$NEXTPREV_TEMPLATE['bootstrap_item'] = '
    <li class="page-item"><a class="page-link hidden-xs d-none d-sm-block" href="{url}" title="{url_label}">{label}</a></li>
';
$NEXTPREV_TEMPLATE['bootstrap_item_current'] = '
    <li class="page-item active disabled" aria-current="page"><a class="page-link" href="#" onclick="return false;" title="{url_label}">{label}</a></li>
';
