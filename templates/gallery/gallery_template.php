...
$GALLERY_TEMPLATE['list']['item'] = '
    <div class="col-lg-4 grid-item">
      <div class="gallery-item-box shadow">
		{GALLERY_THUMB: w=1000&h=1000&class=gallery-item img-fluid}
...
$GALLERY_TEMPLATE['cat']['item'] = '
    <div class="col-lg-6 grid-item">
      <div class="gallery-cat-item-box shadow">
        <a class="gallery-cat-item" href="{GALLERY_CAT_URL}">
          <div class="gallery-cat-item-overlay">
            <span class="eye"></span>
          </div>
		  <img src="{GALLERY_CAT_THUMB: w=1000&h=1000&thumbsrc&class=img-fluid}" />
        </a>
		<div class="gallery-cat-item-title">
...
<div class="gallery-slideshow-controls text-center">
  <div class="d-inline-block"><a href="#" class="gallery-control gal-prev btn btn-sm btn-xs btn-default btn-secondary">{GLYPH=fa-chevron-left} '.LAN_PREVIOUS.'</a></div>
  <div class="d-inline-block"><a href="#" class="gallery-control gal-next btn btn-sm btn-xs btn-default btn-secondary pull-right float-right">'.LAN_NEXT.' {GLYPH=fa-chevron-right}</a></div>
  <div class="gallery-slide-jumper-container clearfix">
    {GALLERY_JUMPER}
  </div>
</div>
';
...
<!-- start portfolio -->
<div class="portfolio-header text-center">{LAN=LAN_PLUGIN_GALLERY_TITLE}</div>
<div id ="portfolio-gallery">
  <div class="row">
';
$GALLERY_TEMPLATE['portfolio']['item'] = '
    <div class="col-lg-3 mb-3">
      <img src="{GALLERY_THUMB: w=1000&h=800&thumbsrc}" class="img-fluid shadow" alt="{GALLERY_CAPTION=text}" />
    </div>
';
