...
<div id='forum-post'>
  ...
  <div class='forum-post-caption'>{FORUM_POST_CAPTION}</div>
  ...
  <div class='form-group'>
    <div class='row border-bottom border-secondary border-opacity-25 py-2'>
      <label for='name' class='col-md-3 control-label'>{LAN=FORUM_3010}</label>
      <div class='col-md-9'>{FORUM_POST_AUTHOR}</div>
    </div>
  </div>
  <div class='form-group'>
    <div class='row border-bottom border-secondary border-opacity-25 py-2'>
      <label for='subject' class='col-md-3 control-label'>{LAN=FORUM_3011}</label>
      <div class='col-md-9'>{FORUM_POST_SUBJECT}</div>
    </div>
  </div>
  <div class='form-group'>
    <div class='row border-bottom border-secondary border-opacity-25 py-2'>
      <label class='col-md-3 control-label'>{FORUM_POST_TEXTAREA_LABEL}</label>
      <div class='col-md-9'>
        {FORUM_POST_TEXTAREA}
  ...
  <div class='form-group'>
    <div class='row border-bottom border-secondary border-opacity-25 py-2'>
      <label class='col-md-3 control-label'>{FORUM_POST_OPTIONS_LABEL}</label>
      <div class='col-md-9'>{FORUM_POST_OPTIONS}</div>
    </div>
  </div>
