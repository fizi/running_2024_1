...
<ul class='media-list list-unstyled newforumposts-menu'>
";
$NEWFORUMPOSTS_MENU_TEMPLATE['default']['item'] = "
  <li class='d-flex mb-3'>
	<div class='flex-shrink-0'>
      {SETIMAGE: w=26&h=26&crop=1}
      {POST_AUTHOR_AVATAR: shape=circle&size=26&crop=1}
    </div>
	<div class='flex-grow-1 ms-3'>
	  <div class='text-uppercase small fw-bold'><a href='{POST_URL}'>{POST_TOPIC}</a></div>
      <div class='text-muted small'>{POST_CONTENT}</div>
      <div class='small text-muted'>{LAN=FORUM_MENU_001} {POST_AUTHOR_NAME} {POST_DATESTAMP}</div>
	</div>
  </li>
";
